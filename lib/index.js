...
function flightStatsConnector( parentDirPath ){
	 ...
	 */
	var busiestAirports = ['DFW','DEN','CLT','PHX','IAH','MIA','SEA','EWR','MCO','MSP','DTW',
	                       'LGA','FLL','BWI','IAD','MDW','SLC','DCA','HNL','TPA'];
	var tenbusiestAirports = ['ATL','LAX','ORD','JFK','SFO','LAS','BOS','PHL','SAN','PDX'];
	this.getTables = function(){
		return [
	        {name : null, labelPlural : 'All Sets'},
	        {name : 'mega_set', labelPlural : 'Mega Set from 20 busiest airports', CLIENT_airportCodes:busiestAirports},
	        {name : 'mega_subset', labelPlural : 'Mega SubSet from 10 busiest airports', CLIENT_airportCodes:tenbusiestAirports},
