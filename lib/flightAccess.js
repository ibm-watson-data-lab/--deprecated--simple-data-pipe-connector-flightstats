...
var buildUrl = module.exports.buildUrl = function( appId, appKey, path, params ){
...
if(process.env.TEST){
module.exports.getFlights = function( appId, appKey, airportInfo, date, callback ){
	request.get("http://127.0.0.1:5984/flightstats_training_data_for_flight_delay_predictive_app_mega_set/_design/mega_set/_view/airports?key=%22"+airportInfo.fs+"%22&include_docs=true&limit=10",
	...
	module.exports.getFlights = function( appId, appKey, airportInfo, date, callback ){
		var connectedUrl = buildUrl(appId, appKey,
...
module.exports.addStatusAndWeatherInfo = function( appId, appKey, flight, date, airportData, pushRecordFn, callback ){
	...
	//Get flight status
	var statusUrl = buildUrl( appId, appKey, "flightstatus/rest/v2/json/flight/status/" 
...
module.exports.loadAirlines = function( appId, appKey, callback ){
	var targetDb = this;
	var connectedUrl = buildUrl(appId, appKey, "airlines/rest/v1/json/active");
...
module.exports.loadAirports = function( appId, appKey, callback ){
	var targetDb = this;
	var connectedUrl = buildUrl(appId, appKey, "airports/rest/v1/json/active");
